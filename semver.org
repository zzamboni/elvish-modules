...
The =semver:cmp= function receives two version numbers in the form MAJOR.MINOR.PATCH-LABEL (where all components except for MAJOR) are optional and returns their order as -1, 0 or 1. The [[semver:>  1.0.0 1.0.0-rc1 0.9.0][algorithm]] is as follows:
